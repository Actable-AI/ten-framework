"""
Unit tests for BlazeSTTRealtimeExtension
"""
...
from blaze_stt_realtime_python import (
    BlazeSTTRealtimeConfig,
    BlazeSTTRealtimeExtension,
)


class TestBlazeSTTRealtimeExtension:
    """Test suite for BlazeSTTRealtimeExtension"""

    def test_init_with_config_dict(self, mock_config):
        """Test initialization with dict config"""
        stt = BlazeSTTRealtimeExtension(config=mock_config)
    ...
    def test_init_with_config_object(self):
        """Test initialization with BlazeSTTRealtimeConfig object"""
        config = BlazeSTTRealtimeConfig(
            api_url="https://test.com",
            api_key="test-key",
            default_language="en",
            default_model="stt-stream-1.5",
        )
        stt = BlazeSTTRealtimeExtension(config=config)
    ...
    def test_init_with_env_vars(self, monkeypatch):
        ...
        stt = BlazeSTTRealtimeExtension(config=None)
    ...
    def test_build_ws_url(self):
        ...
        build = BlazeSTTRealtimeExtension._build_ws_url
